...
describe Cms::Line::DeliverCondition, type: :model, dbscope: :example do
  ...
  describe "members condition" do
    let!(:item) { create :cms_line_deliver_condition }
  ...
  describe "members condition1" do
    let!(:item) { create :cms_line_deliver_condition1 }
  ...
  #  let!(:item) { create :cms_line_deliver_condition2 }
  #
  #  it do
  ...
  #  let!(:item) { create :cms_line_deliver_condition3 }
  #
  #  it do
