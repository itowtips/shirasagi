...
describe "gws_portal_preset_portlets", type: :feature, dbscope: :example, js: true do
  let(:site) { gws_site }
  let!(:preset) { create(:gws_portal_preset, portal_type: "organization") }
  ...
  context "basic crud" do
    ...
    it "#new" do
      ...
      within ".main-box" do
        ...
        expect(page).to have_no_link I18n.t("gws/portal.portlets.reminder.name")
        expect(page).to have_link I18n.t("gws/portal.portlets.schedule.name")
        expect(page).to have_no_link I18n.t("gws/portal.portlets.todo.name")
