    ...
    describe "test deliver" do
      ...
      it "sends text mail" do
        ...
        within "form" do
          ...
          choose "item_email_type_text"
          click_button "保存"
        end

        expect(status_code).to eq 200
        expect(page).to have_css(".see dd", text: email)
        expect(page).to have_css(".see dd", text: "text")
        ...
        expect(status_code).to eq 200
        expect(page).to have_css("table.index tbody tr.list-item td a", text: email)
        expect(page).to have_css("table.index tbody tr.list-item td", text: "text")
      ...
      it "sends html mail" do
        ...
        within "form" do
          fill_in "item[email]", with: email
          choose "item_email_type_html"
          click_button "保存"
        end

        expect(status_code).to eq 200
        expect(page).to have_css(".see dd", text: email)
        expect(page).to have_css(".see dd", text: "html")
        ...
        expect(status_code).to eq 200
        expect(page).to have_css("table.index tbody tr.list-item td a", text: email)
        expect(page).to have_css("table.index tbody tr.list-item td", text: "html")
