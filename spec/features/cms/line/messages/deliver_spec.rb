...
describe "cms/line/messages deliver", type: :feature, dbscope: :example, js: true do
  let(:site) { cms_site }
  ...
  context "multicast_with_registered_condition" do
    ...
    it "#new" do
      ...
      within "form#item-form" do
        fill_in "item[name]", with: name
        select I18n.t("cms.options.line_deliver_condition_state.multicast_with_registered_condition"), from: 'item[deliver_condition_state]'
