...
describe "tourism_notices", type: :feature, dbscope: :example, js: true do
  let(:site) { cms_site }
  ...
  let(:index_path) { tourism_notices_path site.id, node }
  let(:new_path) { new_tourism_notice_path site.id, node }
  let(:show_path) { tourism_notice_path site.id, node, item }
  let(:edit_path) { edit_tourism_notice_path site.id, node, item }
  let(:delete_path) { delete_tourism_notice_path site.id, node, item }
