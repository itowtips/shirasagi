...
describe "my_group", type: :feature, dbscope: :example, js: true do
  ...
  context "with toursim/page" do
    ...
    let!(:item) { create(:tourism_page, cur_node: node, layout_id: layout.id, facility: facility_page, state: 'closed', release_date: release_date) }
    ...
    let(:show_path) { tourism_page_path(site, node, item) }
