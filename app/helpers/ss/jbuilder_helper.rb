  ...
  module Utils
    ...
    def jsonize_user(user)
      ...
      I18n.available_locales.each do |lang|
        ret["name_#{lang}".to_sym] = user.i18n_name_translations[lang]
      end
      ret[:uid] = user.uid if user.uid.present?
      ret[:email] = user.email if user.email.present?
      ret
    end
    ...
    def jsonize_group(group)
      ret = {}
      I18n.available_locales.each do |lang|
        ret["name_#{lang}".to_sym] = group.i18n_name_translations[lang]
      end
      ret
    end
