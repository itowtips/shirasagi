class Garbage::Description::ImportJob < Cms::ApplicationJob
  include Job::SS::TaskFilter

  self.task_class = Cms::Task
  self.task_name = "garbage:import_node_descriptions"
  self.controller = Garbage::Agents::Tasks::Node::DescriptionsController
  self.action = :import
