  ...
  def perform
    ...
    dataset_ids.each do |id|
      ...
      if update_plan_date == today
        datasets << dataset
      elsif dataset.update_plan_unit == "year" && update_plan_date.month == today.month && update_plan_date.day == today.day
        datasets << dataset
      elsif dataset.update_plan_unit == "month" && update_plan_date.day == today.day
        datasets << dataset
      end
    end
