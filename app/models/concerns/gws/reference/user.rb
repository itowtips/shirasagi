module Gws::Reference
  module User
    ...
    included do
      ...
      field :user_group_i18n_name, type: String, localize: true
    ...
    def set_user_id
      ...
      if group
        self.user_group_id   = group.id
        self.user_group_name = group.name
        self.user_group_i18n_name_translations = group.i18n_name_translations
      end
    end
  end
end
