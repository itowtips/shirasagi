module JobDb
  class Initializer
    ...
    # incidents
    Sys::Role.permission :read_other_job_db_incidents, module_name: "job_db"
    Sys::Role.permission :read_private_job_db_incidents, module_name: "job_db"
    Sys::Role.permission :edit_other_job_db_incidents, module_name: "job_db"
    Sys::Role.permission :edit_private_job_db_incidents, module_name: "job_db"
    Sys::Role.permission :delete_other_job_db_incidents, module_name: "job_db"
    Sys::Role.permission :delete_private_job_db_incidents, module_name: "job_db"
  end
end
