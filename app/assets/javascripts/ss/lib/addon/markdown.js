this.SS_Addon_Markdown = (function () {
  ...
  SS_Addon_Markdown.render = function (el, options) {
    ...
    $el.find("." + this.options)
      ...
      .append("<a href='" + this.helpUrl + "' class='" + this.helpButton + "' target='_blank'>" + i18next.t("ss.links.markdown_help") + "</a>");

    return new SS_Addon_Markdown("." + SS_Addon_Markdown.container, options);
  };

  SS_Addon_Markdown.renderFormMarkdown = function () {
    $("." + this.options).append("<input type='button' class='btn " + this.previewButton + "' value='" + i18next.t("ss.links.preview") + "' />");
    $("." + this.options).append("<a href='" + this.helpUrl + "' class='" + this.helpButton + "' target='_blank' rel='noopener'>" + i18next.t("ss.links.markdown_help") + "</a>");
